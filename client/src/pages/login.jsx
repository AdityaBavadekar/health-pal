...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-emerald-50 via-cyan-50 to-teal-100 p-4 relative overflow-hidden">
      ...
      <div className="relative bg-white/95 backdrop-blur-md shadow-2xl rounded-3xl p-6 mt-8 w-full max-w-2xl border border-white/30 transform transition-all duration-500 hover:shadow-3xl hover:bg-white/98">
