...
>>>>>>> 02fb44bd70cea947712bbf59827b1e91944462d5
      ...
      <section className="h-screen bg-[url('assets/img_srcs/home.png')] bg-cover bg-center bg-fixed flex items-center justify-center">
        <div className="text-center text-white p-8 max-w-2xl">
          ...
          <div className="flex justify-center gap-8">
            <button className="bg-emerald-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-emerald-600 transition duration-300 w-40">
              {" "}
              {/* Added w-40 for fixed width */}
              Sign Up
            </button>
            <button className="bg-transparent text-white px-8 py-4 rounded-full text-lg font-semibold border-2 border-white hover:bg-white hover:text-emerald-500 transition duration-300 w-40">
              {" "}
              {/* Added w-40 for fixed width */}
              Log In
            </button>
      ...
      <section className="py-48 px-8 bg-emerald-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-emerald-700 leading-relaxed">
            Welcome to HealthPal, a healthcare platform designed to connects
            patients, doctors, and hospitals easily, making healthcare
            accessible and efficient. Our goal is to provide people with
            resources necessary to manage their health and to offer healthcare
            providers efficient tools for better care.
          </p>
          <p className="text-xl text-emerald-700 leading-relaxed">
            In today’s fast-paced world, maintaining good health can be
            difficult. For this reason, we developed HealthPal to simplify,
            increase accessibility, and personalize healthcare management. Our
            platform combines modern technologies, such as picture text
            recognition and generative AI, to create an easy interface for
          ...
          <div className="flex justify-center">
            <div className="max-w-3xl text-white text-center">
              ...
              <p className="text-emerald-100 text-lg leading-relaxed mb-8">
                HealthPal helps patients by making managing their health much
                easier. Often, patients forget to take their medicine or miss
                appointments, which can harm their health. By having automatic
                reminders for medications and appointment scheduling, patients
                can stay on track with their treatment. It also helps them feel
                more in control of their health, as they can easily access their
                medical history and get answers to their health-related
                questions without waiting for a doctor's visit. Additionally,
                finding and buying medicine becomes less of a hassle, as they
                can order it directly or find nearby pharmacies. This platform
                saves patients time, reduces stress, and ensures they follow
                their health plan more effectively.
              </p>
...
<<<<<<< HEAD
            ...
            patients. Doctors often have to spend a lot of time reviewing
            patient histories and organizing appointments. Doctors can make
            faster and more accurate decisions with quick access to patient
            records and AI-generated summaries. The platform allows them to
            easily communicate with patients, answering questions or giving
            advice without needing extra appointments. This helps doctors focus
            more on providing care rather than handling paperwork, improving
            their efficiency. Overall, the platform simplifies their daily
            tasks, allowing them to offer better care while reducing their
            workload.
          </p>
          <button className="bg-emerald-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-emerald-600 transition duration-300 inline-flex items-center justify-center mx-auto">
...
>>>>>>> 02fb44bd70cea947712bbf59827b1e91944462d5
      ...
      <section className="py-48 bg-fixed bg-cover bg-center relative bg-[url('https://images.unsplash.com/photo-1552674605-db6ffd4facb5?q=80&w=2070')]">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-8">
          ...
          <p className="text-xl text-emerald-100 mb-12">
            At HealthPal, we aim to bridge the gap between patients and doctors
            by providing a smart, user-friendly healthcare platform. We believe
            in making healthcare more efficient and accessible for everyone. Our
            platform improves patient health, and enhances the doctor-patient
            relationship, creating a healthier future for all. Join us in
            transforming the healthcare journey by making it easier and safer.{" "}
          </p>
        </div>
      </section>
